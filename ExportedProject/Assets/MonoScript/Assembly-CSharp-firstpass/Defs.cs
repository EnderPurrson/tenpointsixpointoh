...
public sealed class Defs
{
	...
	public static bool isActivABTestRatingSystem
	{
		get
		{
			if (!_isInitActivABTestRatingSystem)
			{
				_isActivABTestRatingSystem = PlayerPrefs.GetInt(nonActivABTestRatingSystemKey, 1) == 0;
				_isInitActivABTestRatingSystem = true;
			}
			return _isActivABTestRatingSystem;
		}
		set
		{
			_isActivABTestRatingSystem = value;
			_isInitActivABTestRatingSystem = true;
			PlayerPrefs.SetInt(nonActivABTestRatingSystemKey, (!value) ? 1 : 0);
		}
	}
	...
	public static ABTestCohortsType cohortABTestSandBox
	{
		get
		{
			if (!_isInitCohortABTestSandBox)
			{
				_cohortABTestSandBox = (ABTestCohortsType)PlayerPrefs.GetInt(cohortABTestSandBoxKey, 0);
				_isInitCohortABTestSandBox = true;
			}
			return _cohortABTestSandBox;
		}
		set
		{
			_cohortABTestSandBox = value;
			_isInitCohortABTestSandBox = true;
			PlayerPrefs.SetInt(cohortABTestSandBoxKey, (int)_cohortABTestSandBox);
		}
	}

	public static ABTestCohortsType cohortABTestQuestSystem
	{
		get
		{
			if (!_isInitCohortABTestQuestSystem)
			{
				_cohortABTestQuestSystem = (ABTestCohortsType)PlayerPrefs.GetInt(cohortABTestQuestSystemKey, 0);
				_isInitCohortABTestQuestSystem = true;
			}
			return _cohortABTestQuestSystem;
		}
		set
		{
			_cohortABTestQuestSystem = value;
			_isInitCohortABTestQuestSystem = true;
			PlayerPrefs.SetInt(cohortABTestQuestSystemKey, (int)_cohortABTestQuestSystem);
		}
	}

	public static ABTestCohortsType cohortABTestSpecialOffers
	{
		get
		{
			if (!_isInitCohortABTestSpecialOffers)
			{
				_cohortABTestSpecialOffers = (ABTestCohortsType)PlayerPrefs.GetInt(cohortABTestSpecialOffersKey, 0);
				_isInitCohortABTestSpecialOffers = true;
			}
			return _cohortABTestSpecialOffers;
		}
		set
		{
			_cohortABTestSpecialOffers = value;
			_isInitCohortABTestSpecialOffers = true;
			PlayerPrefs.SetInt(cohortABTestSpecialOffersKey, (int)_cohortABTestSpecialOffers);
		}
	}
	...
	static Defs()
	{
		...
		nonActivABTestRatingSystemKey = "nonActivABTestRatingSystemKey";
		nonActivABTestStaticBankKey = "nonActivABTestStaticBankKey";
		nonActivABTestBuffSystemKey = "nonActivABTestBuffSystemKey";
		cohortABTestSandBoxKey = "cohortABTestSandBoxKey";
		cohortABTestQuestSystemKey = "cohortABTestQuestSystemKey";
		cohortABTestSpecialOffersKey = "cohortABTestSpecialOffersKey";

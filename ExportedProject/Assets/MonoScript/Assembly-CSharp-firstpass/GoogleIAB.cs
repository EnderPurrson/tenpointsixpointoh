...
public class GoogleIAB
{
	...
	public static bool areSubscriptionsSupported()
	{
		...
		return GoogleIAB._plugin.Call<bool>("areSubscriptionsSupported", new object[0]);
	}
	...
	public static void consumeProduct(string sku)
	{
		...
		GoogleIAB._plugin.Call("consumeProduct", new object[] { sku });
	}
	...
	public static void consumeProducts(string[] skus)
	{
		...
		GoogleIAB._plugin.Call("consumeProducts", new object[] { skus });
	}
	...
	public static void enableLogging(bool shouldEnable)
	{
		...
		GoogleIAB._plugin.Call("enableLogging", new object[] { shouldEnable });
	}
	...
	public static void init(string publicKey)
	{
		...
		GoogleIAB._plugin.Call("init", new object[] { publicKey });
	}
	...
	public static void purchaseProduct(string sku, string developerPayload)
	{
		...
		GoogleIAB._plugin.Call("purchaseProduct", new object[] { sku, developerPayload });
	}
	...
	public static void queryInventory(string[] skus)
	{
		...
		GoogleIAB._plugin.Call("queryInventory", new object[] { skus });
	}
	...
	public static void setAutoVerifySignatures(bool shouldVerify)
	{
		...
		GoogleIAB._plugin.Call("setAutoVerifySignatures", new object[] { shouldVerify });
	}

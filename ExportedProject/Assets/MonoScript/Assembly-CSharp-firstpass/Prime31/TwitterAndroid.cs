...
namespace Prime31
{
	public class TwitterAndroid
	{
		...
		public static void init(string consumerKey, string consumerSecret, string callbackUrlScheme = "twitterplugin")
		{
			...
			TwitterAndroid._plugin.Call("init", new object[] { consumerKey, consumerSecret, callbackUrlScheme });
		}
		...
		public static bool isLoggedIn()
		{
			...
			return TwitterAndroid._plugin.Call<bool>("isLoggedIn", new object[0]);
		}
		...
		public static void performRequest(string methodType, string path, Dictionary<string, string> parameters)
		{
			...
			string str = (parameters == null ? string.Empty : parameters.toJson());
			TwitterAndroid._plugin.Call("performRequest", new object[] { methodType, path, str });
		}
		...
		public static void postStatusUpdate(string status)
		{
			...
			TwitterAndroid.performRequest("post", "/1.1/statuses/update.json", strs);
		}
		...
		public static void postStatusUpdate(string update, byte[] image)
		{
			...
			TwitterAndroid._plugin.Call("postUpdateWithImage", new object[] { update, image });
		}
		...
		public static void showLoginDialog(bool useExternalBrowserForAuthentication = false)
		{
			...
			TwitterAndroid._plugin.Call("showLoginDialog", new object[] { useExternalBrowserForAuthentication });
		}
	}
}
								...
								default:
								{
									switch (peekChar)
									{
										...
										case '|':
										{
											...
											if (nextWord != null)
											{
												if (Json.Parser.u003cu003ef__switchu0024map0 == null)
												{
													...
													Json.Parser.u003cu003ef__switchu0024map0 = strs;
												}
												if (Json.Parser.u003cu003ef__switchu0024map0.TryGetValue(nextWord, out num))
												{
													switch (num)
													{
														case 0:

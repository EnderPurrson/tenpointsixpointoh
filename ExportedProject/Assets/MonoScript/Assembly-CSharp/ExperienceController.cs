...
public sealed class ExperienceController : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static Func<Weapon, bool> _003C_003Ef__am_0024cache1C;

	[CompilerGenerated]
	private static Func<Weapon, bool> _003C_003Ef__am_0024cache1D;

	[CompilerGenerated]
	private static Func<Weapon, bool> _003C_003Ef__am_0024cache1E;

	[CompilerGenerated]
	private static Func<Weapon, bool> _003C_003Ef__am_0024cache1F;
			...
			if (!TrainingController.TrainingCompleted && TrainingController.CompletedTrainingStage == TrainingController.NewTrainingCompletedStage.ShopCompleted && currentLevel > 1)
			{
				...
				try
				{
					if (WeaponManager.sharedManager != null && WeaponManager.sharedManager.playerWeapons != null)
					{
						...
						{
							_003C_003Ef__am_0024cache1C = _003CaddExperience_003Em__40;
						}
						if (source.FirstOrDefault(_003C_003Ef__am_0024cache1C) == null)
						{
							...
							{
								_003C_003Ef__am_0024cache1D = _003CaddExperience_003Em__41;
							}
							sharedManager.EquipWeapon(source2.First(_003C_003Ef__am_0024cache1D));
						}
						if (_003C_003Ef__am_0024cache1E == null)
						{
							_003C_003Ef__am_0024cache1E = _003CaddExperience_003Em__42;
						}
						if (source.FirstOrDefault(_003C_003Ef__am_0024cache1E) == null)
						{
							WeaponManager sharedManager2 = WeaponManager.sharedManager;
							IEnumerable<Weapon> source3 = WeaponManager.sharedManager.allAvailablePlayerWeapons.OfType<Weapon>();
							if (_003C_003Ef__am_0024cache1F == null)
							{
								_003C_003Ef__am_0024cache1F = _003CaddExperience_003Em__43;
							}
							sharedManager2.EquipWeapon(source3.First(_003C_003Ef__am_0024cache1F));
						}
					}
				}
				catch (Exception ex)
	...
	[CompilerGenerated]
	private static bool _003CaddExperience_003Em__40(Weapon w)
	{
		return w.weaponPrefab.GetComponent<WeaponSounds>().categoryNabor - 1 == 3;
	}

	[CompilerGenerated]
	private static bool _003CaddExperience_003Em__41(Weapon w)
	{
		return w.weaponPrefab.name.Replace("(Clone)", string.Empty) == WeaponManager.SimpleFlamethrower_WN;
	}

	[CompilerGenerated]
	private static bool _003CaddExperience_003Em__42(Weapon w)
	{
		return w.weaponPrefab.GetComponent<WeaponSounds>().categoryNabor - 1 == 5;
	}

	[CompilerGenerated]
	private static bool _003CaddExperience_003Em__43(Weapon w)
	{
		return w.weaponPrefab.name.Replace("(Clone)", string.Empty) == WeaponManager.Rocketnitza_WN;
	}
}

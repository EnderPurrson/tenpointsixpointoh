...
namespace Facebook.MiniJSON
{
	public static class Json
	{
		...
		static Json()
		{
			Json.numberFormat = (new CultureInfo("en-US")).NumberFormat;
		}
								...
								default:
								{
									switch (peekChar)
									{
										...
										case '|':
										{
											...
											if (nextWord != null)
											{
												if (Json.Parser.u003cu003ef__switchu0024map1 == null)
												{
													...
													Json.Parser.u003cu003ef__switchu0024map1 = strs;
												}
												if (Json.Parser.u003cu003ef__switchu0024map1.TryGetValue(nextWord, out num))
												{
													switch (num)
													{
														case 0:
						...
						else if (this.json.Peek() != -1)
						{
							...
							switch (chr1)
							{
								...
								case 'u':
								{
									...
									for (int i = 0; i < 4; i++)
									{
										stringBuilder1.Append(this.NextChar);
									}
									stringBuilder.Append((char)Convert.ToInt32(stringBuilder1.ToString(), 16));
									break;
								}
								default:
								{
					...
					switch (chr1)
					{
						...
						default:
						{
							...
							else
							{
								...
								if (num < 32 || num > 126)
								{
									this.builder.Append(string.Concat("\\u", Convert.ToString(num, 16).PadLeft(4, '0')));
								}
								else
								{

...
namespace Facebook.Unity
{
	public sealed class FB : ScriptableObject
	{
		...
		[CompilerGenerated]
		private sealed class _003CInit_003Ec__AnonStorey1EF
		{
			...
			internal void _003C_003Em__44()
			{
				((EditorFacebook)facebook).Init(onHideUnity, onInitComplete);
			}

			internal void _003C_003Em__45()
			{
		...
		{
			_003CInit_003Ec__AnonStorey1EF _003CInit_003Ec__AnonStorey1EF = new _003CInit_003Ec__AnonStorey1EF();
			_003CInit_003Ec__AnonStorey1EF.onHideUnity = onHideUnity;
			_003CInit_003Ec__AnonStorey1EF.onInitComplete = onInitComplete;
			_003CInit_003Ec__AnonStorey1EF.appId = appId;
			_003CInit_003Ec__AnonStorey1EF.cookie = cookie;
			_003CInit_003Ec__AnonStorey1EF.logging = logging;
			_003CInit_003Ec__AnonStorey1EF.status = status;
			_003CInit_003Ec__AnonStorey1EF.xfbml = xfbml;
			_003CInit_003Ec__AnonStorey1EF.authResponse = authResponse;
			_003CInit_003Ec__AnonStorey1EF.frictionlessRequests = frictionlessRequests;
			_003CInit_003Ec__AnonStorey1EF.jsSDKLocale = jsSDKLocale;
			if (string.IsNullOrEmpty(_003CInit_003Ec__AnonStorey1EF.appId))
			{
				throw new ArgumentException("appId cannot be null or empty!");
			}
			AppId = _003CInit_003Ec__AnonStorey1EF.appId;
			if (!isInitCalled)
			{
				isInitCalled = true;
				if (Constants.IsEditor)
				{
					OnDLLLoadedDelegate = _003CInit_003Ec__AnonStorey1EF._003C_003Em__44;
				...
				case FacebookUnityPlatform.WebPlayer:
					OnDLLLoadedDelegate = _003CInit_003Ec__AnonStorey1EF._003C_003Em__45;
					ComponentFactory.GetComponent<CanvasFacebookLoader>();
					break;
				case FacebookUnityPlatform.IOS:
					OnDLLLoadedDelegate = _003CInit_003Ec__AnonStorey1EF._003C_003Em__46;
					ComponentFactory.GetComponent<IOSFacebookLoader>();
					break;
				case FacebookUnityPlatform.Android:
					OnDLLLoadedDelegate = _003CInit_003Ec__AnonStorey1EF._003C_003Em__47;

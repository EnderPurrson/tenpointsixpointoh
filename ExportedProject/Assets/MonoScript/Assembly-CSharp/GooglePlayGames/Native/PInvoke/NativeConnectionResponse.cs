...
namespace GooglePlayGames.Native.PInvoke
{
	internal class NativeConnectionResponse : BaseReferenceHolder
	{
		...
		{
			return PInvokeUtilities.OutParamsToString(_003CRemoteEndpointId_003Em__136);
		}
		...
		{
			return PInvokeUtilities.OutParamsToArray<byte>(_003CPayload_003Em__137);
		}
		...
		[CompilerGenerated]
		private UIntPtr _003CRemoteEndpointId_003Em__136(StringBuilder out_arg, UIntPtr out_size)
		{
			return NearbyConnectionTypes.ConnectionResponse_GetRemoteEndpointId(SelfPtr(), out_arg, out_size);
		}

		[CompilerGenerated]
		private UIntPtr _003CPayload_003Em__137(byte[] out_arg, UIntPtr out_size)
		{

...
namespace GooglePlayGames.Native.PInvoke
{
	internal class NativeTurnBasedMatch : BaseReferenceHolder
	{
		...
		{
			return PInvokeUtilities.ToEnumerable(GooglePlayGames.Native.Cwrapper.TurnBasedMatch.TurnBasedMatch_Participants_Length(SelfPtr()), _003CParticipants_003Em__157);
		}
		...
		{
			return PInvokeUtilities.OutParamsToString(_003CDescription_003Em__158);
		}
		...
		{
			return PInvokeUtilities.OutParamsToString(_003CRematchId_003Em__159);
		}
		...
		internal byte[] Data()
		{
			...
			return PInvokeUtilities.OutParamsToArray<byte>(_003CData_003Em__15A);
		}

		internal string Id()
		{
			return PInvokeUtilities.OutParamsToString(_003CId_003Em__15B);
		}
		...
		[CompilerGenerated]
		private MultiplayerParticipant _003CParticipants_003Em__157(UIntPtr index)
		{

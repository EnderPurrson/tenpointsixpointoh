...
namespace GooglePlayGames.Native.PInvoke
{
	internal class NearbyConnectionsManager : BaseReferenceHolder
	{
		...
		[CompilerGenerated]
		private static Func<NativeAppIdentifier, IntPtr> _003C_003Ef__am_0024cache1;
		...
		{
			return PInvokeUtilities.OutParamsToString(_003CLocalEndpointId_003Em__15D);
		}

		internal string LocalDeviceId()
		{
			return PInvokeUtilities.OutParamsToString(_003CLocalDeviceId_003Em__15E);
		}
		...
		[CompilerGenerated]
		private static IntPtr _003CStartAdvertising_003Em__15C(NativeAppIdentifier id)
		{
			return id.AsPointer();
		}

		[CompilerGenerated]
		private UIntPtr _003CLocalEndpointId_003Em__15D(StringBuilder out_arg, UIntPtr out_size)
		{
			return NearbyConnections.NearbyConnections_GetLocalEndpointId(SelfPtr(), out_arg, out_size);
		}

		[CompilerGenerated]
		private UIntPtr _003CLocalDeviceId_003Em__15E(StringBuilder out_arg, UIntPtr out_size)
		{

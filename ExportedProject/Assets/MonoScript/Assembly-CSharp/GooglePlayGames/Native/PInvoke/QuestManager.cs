...
namespace GooglePlayGames.Native.PInvoke
{
	internal class QuestManager
	{
		...
		internal class FetchListResponse : BaseReferenceHolder
		{
			...
			{
				return PInvokeUtilities.ToEnumerable(GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_FetchListResponse_GetData_Length(SelfPtr()), _003CData_003Em__163);
			}
			...
			[CompilerGenerated]
			private NativeQuest _003CData_003Em__163(UIntPtr index)
			{

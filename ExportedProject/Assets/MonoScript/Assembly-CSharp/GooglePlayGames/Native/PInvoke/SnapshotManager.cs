	...
	internal class SnapshotManager
	{
		internal class OpenResponse : BaseReferenceHolder
		{
			...
			internal string ConflictId()
			{
				...
				return PInvokeUtilities.OutParamsToString(_003CConflictId_003Em__167);
			}
			...
			[CompilerGenerated]
			private UIntPtr _003CConflictId_003Em__167(StringBuilder out_string, UIntPtr out_size)
			{
				return GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_OpenResponse_GetConflictId(SelfPtr(), out_string, out_size);
			}
		}
		...
		internal class FetchAllResponse : BaseReferenceHolder
		{
			...
			{
				return PInvokeUtilities.ToEnumerable(GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_FetchAllResponse_GetData_Length(SelfPtr()), _003CData_003Em__168);
			}
			...
			[CompilerGenerated]
			private NativeSnapshotMetadata _003CData_003Em__168(UIntPtr index)
			{
				return new NativeSnapshotMetadata(GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_FetchAllResponse_GetData_GetElement(SelfPtr(), index));
			}
		}
		...
		internal class ReadResponse : BaseReferenceHolder
		{
			...
			internal byte[] Data()
			{
				...
				return PInvokeUtilities.OutParamsToArray<byte>(_003CData_003Em__169);
			}
			...
			[CompilerGenerated]
			private UIntPtr _003CData_003Em__169(byte[] out_bytes, UIntPtr out_size)
			{
				return GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_ReadResponse_GetData(SelfPtr(), out_bytes, out_size);
			}
		}

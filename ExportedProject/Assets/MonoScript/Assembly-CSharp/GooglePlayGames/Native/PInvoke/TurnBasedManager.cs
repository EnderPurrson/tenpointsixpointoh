...
namespace GooglePlayGames.Native.PInvoke
{
	internal class TurnBasedManager
	{
		...
		internal class TurnBasedMatchesResponse : BaseReferenceHolder
		{
			...
			{
				return PInvokeUtilities.ToEnumerable(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetInvitations_Length(SelfPtr()), _003CInvitations_003Em__16A);
			}
			...
			{
				return PInvokeUtilities.ToEnumerable(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetMyTurnMatches_Length(SelfPtr()), _003CMyTurnMatches_003Em__16B);
			}
			...
			{
				return PInvokeUtilities.ToEnumerable(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetTheirTurnMatches_Length(SelfPtr()), _003CTheirTurnMatches_003Em__16C);
			}
			...
			{
				return PInvokeUtilities.ToEnumerable(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetCompletedMatches_Length(SelfPtr()), _003CCompletedMatches_003Em__16D);
			}
			...
			[CompilerGenerated]
			private MultiplayerInvitation _003CInvitations_003Em__16A(UIntPtr index)
			{
			...
			[CompilerGenerated]
			private NativeTurnBasedMatch _003CMyTurnMatches_003Em__16B(UIntPtr index)
			{
			...
			[CompilerGenerated]
			private NativeTurnBasedMatch _003CTheirTurnMatches_003Em__16C(UIntPtr index)
			{
			...
			[CompilerGenerated]
			private NativeTurnBasedMatch _003CCompletedMatches_003Em__16D(UIntPtr index)
			{

...
public static class InAppData
{
	...
	[CompilerGenerated]
	private static Func<List<string>, IEnumerable<string>> _003C_003Ef__am_0024cache2;
	...
	static InAppData()
	{
		...
		inAppData.Add(86, new KeyValuePair<string, string>("skin_july1", "skin_july1"));
		inAppData.Add(87, new KeyValuePair<string, string>("skin_july2", "skin_july2"));
		inAppData.Add(88, new KeyValuePair<string, string>("skin_july3", "skin_july3"));
		inAppData.Add(89, new KeyValuePair<string, string>("skin_july4", "skin_july4"));
		...
		inappReadableNames.Add("skin_july1", "skin_july1");
		inappReadableNames.Add("skin_july2", "skin_july2");
		inappReadableNames.Add("skin_july3", "skin_july3");
		inappReadableNames.Add("skin_july4", "skin_july4");
		...
		List<List<string>> source = Wear.wear[ShopNGUIController.CategoryNames.MaskCategory];
		if (_003C_003Ef__am_0024cache2 == null)
		{
			_003C_003Ef__am_0024cache2 = _003CInAppData_003Em__2DC;
		}
		foreach (string item in source.SelectMany(_003C_003Ef__am_0024cache2))
		{
	...
	[CompilerGenerated]
	private static IEnumerable<string> _003CInAppData_003Em__2DC(List<string> list)
	{
		return list;
	}
}

...
public sealed class Initializer : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static Func<ProfileController, bool> _003C_003Ef__am_0024cache32;
	...
	private void ReconnectGUI()
	{
		bool guiActive = ShopNGUIController.GuiActive;
		bool interfaceEnabled = BankController.Instance.InterfaceEnabled;
		ProfileController instance = ProfileController.Instance;
		if (_003C_003Ef__am_0024cache32 == null)
		{
			_003C_003Ef__am_0024cache32 = _003CReconnectGUI_003Em__184;
		}
		bool flag = instance.Map(_003C_003Ef__am_0024cache32);
	...
	public void OnDisconnectedFromPhoton()
	{
		...
		OnConnectionFail(DisconnectCause.DisconnectByServerUserLimit);
	}
	...
	[CompilerGenerated]
	private static bool _003CReconnectGUI_003Em__184(ProfileController p)
	{
		return p.InterfaceEnabled;
	}
}

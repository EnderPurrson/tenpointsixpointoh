...
public class KillRateStatisticsManager
{
	...
	[CompilerGenerated]
	private static Action<Dictionary<string, object>, Dictionary<string, Dictionary<int, int>>> _003C_003Ef__am_0024cache3;
	...
	private static void ParseKillRate(ref Dictionary<string, Dictionary<int, int>> returnWeKill, ref Dictionary<string, Dictionary<int, int>> returnWeWereKilled)
	{
		...
		{
			_003C_003Ef__am_0024cache3 = _003CParseKillRate_003Em__18D;
		}
		Action<Dictionary<string, object>, Dictionary<string, Dictionary<int, int>>> action = _003C_003Ef__am_0024cache3;
	...
	[CompilerGenerated]
	private static void _003CParseKillRate_003Em__18D(Dictionary<string, object> savedDict, Dictionary<string, Dictionary<int, int>> dict)
	{

...
public sealed class NetworkStartTable : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static Action _003C_003Ef__am_0024cache7F;

	[CompilerGenerated]
	private static Action _003C_003Ef__am_0024cache80;

	[CompilerGenerated]
	private static Action<bool> _003C_003Ef__am_0024cache81;
	...
	public void RemoveShop(bool disable = true)
	{
		...
		if (_shopInstance != null)
		{
			...
			{
				_003C_003Ef__am_0024cache7F = _003CRemoveShop_003Em__1D2;
			}
			shopInstance.resumeAction = _003C_003Ef__am_0024cache7F;
			_shopInstance = null;
		}
	}
	...
	public void HandleResumeFromShop()
	{
		if (_shopInstance != null)
		{
			...
			{
				_003C_003Ef__am_0024cache80 = _003CHandleResumeFromShop_003Em__1D3;
			}
			shopInstance.resumeAction = _003C_003Ef__am_0024cache80;
			_shopInstance = null;
		}
	}
	...
	private void StartUnsafe()
	{
		...
		if (isMulti && isMine)
		{
			...
			SynhScore();
			sendMySkin();
			ShopNGUIController.sharedShop.onEquipSkinAction = _003CStartUnsafe_003Em__1D4;
		}
		else
		{
			showTable = false;
	...
	public void win(string winner, int _commandWin = 0, int blueCount = 0, int redCount = 0)
	{
				...
				if (!Defs.isCOOP)
				{
					...
					if (PlayerPrefs.GetInt("LogCountMatch", 0) == 1)
					{
						...
						if (Social.localUser.authenticated)
						{
							...
							{
								_003C_003Ef__am_0024cache81 = _003Cwin_003Em__1D5;
							}
							Social.ReportProgress(achievementID, 100.0, _003C_003Ef__am_0024cache81);
						}
					}
				}
			}
		...
		if (NetworkStartTableNGUIController.sharedController != null)
		{
			...
			{
				NetworkStartTableNGUIController.sharedController.StartCoroutine(NetworkStartTableNGUIController.sharedController.MatchFinishedInterface(winner2, ratingChange, isShowAvard, addCoins, addExperience, LocalOrPasswordRoom(), (!Defs.isHunger) ? (num3 == 0) : isIwin, iAmWinnerInTeam, winnerCommand, blueCount, redCount));
			}
			else
			{
	...
	[CompilerGenerated]
	private static void _003CRemoveShop_003Em__1D2()
	{
	}

	[CompilerGenerated]
	private static void _003CHandleResumeFromShop_003Em__1D3()
	{
	}

	[CompilerGenerated]
	private void _003CStartUnsafe_003Em__1D4(string id)
	{
		sendMySkin();
	}

	[CompilerGenerated]
	private static void _003Cwin_003Em__1D5(bool success)
	{

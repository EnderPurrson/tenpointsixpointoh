...
{
	[CompilerGenerated]
	private sealed class _003CShowRewardWindow_003Ec__AnonStorey284
	{
		internal FacebookController.StoryPriority priority;

		internal void _003C_003Em__1DA()
		{
	...
	[CompilerGenerated]
	private static Func<string> _003C_003Ef__am_0024cache69;

	[CompilerGenerated]
	private static Func<string> _003C_003Ef__am_0024cache6A;

	[CompilerGenerated]
	private static Func<string> _003C_003Ef__am_0024cache6B;
	...
	public NetworkStartTableNGUIController()
	{
		...
		{
			_003C_003Ef__am_0024cache69 = _003C_versionString_003Em__1D6;
		}
		_versionString = new Lazy<string>(_003C_003Ef__am_0024cache69);
		base._002Ector();
	}
	...
	public void InAppropriateActButtonHandler(object sender, EventArgs e)
	{
		if ((!(ExpController.Instance != null) || !ExpController.Instance.IsLevelUpShown) && !ShopNGUIController.GuiActive && !ExperienceController.sharedController.isShowNextPlashka)
		{
			Action handler = _003CInAppropriateActButtonHandler_003Em__1D7;
	...
	public void SexualButtonHandler(object sender, EventArgs e)
	{
		if ((!(ExpController.Instance != null) || !ExpController.Instance.IsLevelUpShown) && !ShopNGUIController.GuiActive && !ExperienceController.sharedController.isShowNextPlashka)
		{
			Action handler = _003CSexualButtonHandler_003Em__1D8;
			FeedbackMenuController.ShowDialogWithCompletion(handler);
		}
	}
	...
	public void OtherButtonHandler(object sender, EventArgs e)
	{
		if ((!(ExpController.Instance != null) || !ExpController.Instance.IsLevelUpShown) && !ShopNGUIController.GuiActive && !ExperienceController.sharedController.isShowNextPlashka)
		{
			Action handler = _003COtherButtonHandler_003Em__1D9;
			FeedbackMenuController.ShowDialogWithCompletion(handler);
		}
	}
	...
	{
		_003CShowRewardWindow_003Ec__AnonStorey284 _003CShowRewardWindow_003Ec__AnonStorey = new _003CShowRewardWindow_003Ec__AnonStorey284();
		...
		_003CShowRewardWindow_003Ec__AnonStorey.priority = FacebookController.StoryPriority.Red;
		component.priority = _003CShowRewardWindow_003Ec__AnonStorey.priority;
		component.twitterPriority = FacebookController.StoryPriority.MultyWinLimit;
		component.shareAction = _003CShowRewardWindow_003Ec__AnonStorey._003C_003Em__1DA;
		component.HasReward = true;
		component.CollectOnlyNoShare = !win;
		if (_003C_003Ef__am_0024cache6A == null)
		{
			_003C_003Ef__am_0024cache6A = _003CShowRewardWindow_003Em__1DB;
		}
		component.twitterStatus = _003C_003Ef__am_0024cache6A;
	...
	public void showAvardPanel(string _winner, int _addCoin, int _addExpierence, bool _isCustom, bool firstPlace, int _winnerCommand)
	{
		...
		rewardWindow.customHide = _003CshowAvardPanel_003Em__1DC;
	...
	public IEnumerator MatchFinishedInterface(string _winner, RatingSystem.RatingChange ratingChange, bool showAward, int _addCoin, int _addExpierence, bool _isCustom, bool firstPlace, bool iAmWinnerInTeam, int _winnerCommand, int blueTotal, int redTotal, bool deadInHunger = false)
	{
		...
		interfaceAnimator.SetBool("isRatingSystem", FriendsController.isUseRatingSystem);
		...
		if (leagueUp)
		{
			...
			for (int m = 0; m < trophyItems.Length; m++)
			{
				...
				trophyItems[m].mainTexture = ItemDb.GetTextureForShopItem(items[m]);
			}
	...
	private void ShareResults()
	{
		...
		{
			_003C_003Ef__am_0024cache6B = _003CShareResults_003Em__1DD;
		}
		twitterStatus = _003C_003Ef__am_0024cache6B;
	...
	{
		if (oldRanksIsActive && hideOldRanksButton.activeSelf)
		{
	...
	[CompilerGenerated]
	private static string _003C_versionString_003Em__1D6()
	{
		return typeof(NetworkStartTableNGUIController).Assembly.GetName().Version.ToString();
	}

	[CompilerGenerated]
	private void _003CInAppropriateActButtonHandler_003Em__1D7()
	{
	...
	[CompilerGenerated]
	private void _003CSexualButtonHandler_003Em__1D8()
	{
		string value = _versionString.Value;
	...
	[CompilerGenerated]
	private void _003COtherButtonHandler_003Em__1D9()
	{
		string value = _versionString.Value;
	...
	[CompilerGenerated]
	private static string _003CShowRewardWindow_003Em__1DB()
	{
		return "I've won a battle in @PixelGun3D! Join the fight now! #pixelgun3d #pixelgun #3d #pg3d #mobile #fps #shooter http://goo.gl/8fzL9u";
	}

	[CompilerGenerated]
	private void _003CshowAvardPanel_003Em__1DC()
	{
	...
	[CompilerGenerated]
	private static string _003CShareResults_003Em__1DD()
	{
		return "I've won a battle in @PixelGun3D! Join the fight now! #pixelgun3d #pixelgun #3d #pg3d #mobile #fps #shooter http://goo.gl/8fzL9u";
	}
}

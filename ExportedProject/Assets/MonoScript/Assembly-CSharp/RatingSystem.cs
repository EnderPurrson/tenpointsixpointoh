...
public class RatingSystem : MonoBehaviour
{
	...
	public void ParseConfig()
	{
		...
		Dictionary<string, object> dictionary = Json.Deserialize(@string) as Dictionary<string, object>;
		if (dictionary == null || !dictionary.ContainsKey("settingRatingSystem"))
		{
			return;
		}
		Dictionary<string, object> dictionary2 = dictionary["settingRatingSystem"] as Dictionary<string, object>;
		if (dictionary2.ContainsKey("min"))
		{
			form_min = Convert.ToInt32(dictionary2["min"]);
		}
		if (dictionary2.ContainsKey("max"))
		{
			form_max = Convert.ToInt32(dictionary2["max"]);
		}
		if (dictionary2.ContainsKey("leveling"))
		{
			List<object> list = dictionary2["leagueRatings"] as List<object>;
			for (int i = 0; i < leagueRatings.Length; i++)
			{
				if (list.Count < i)
				{
		...
		if (dictionary2.ContainsKey("leagueCoefs"))
		{
			List<object> list2 = dictionary2["leagueCoefs"] as List<object>;
		...
		if (dictionary2.ContainsKey("form_kd_a"))
		{
			form_kd_a = (float)Convert.ToDouble(dictionary2["form_kd_a"]);
		}
		if (dictionary2.ContainsKey("form_kd_b"))
		{
			form_kd_b = Convert.ToInt32(dictionary2["form_kd_b"]);
		}
		if (dictionary2.ContainsKey("form_kd_top"))
		{
			form_kd_top = Convert.ToInt32(dictionary2["form_kd_top"]);
		}
		if (dictionary2.ContainsKey("form_place_coeff"))
		{
			form_min = Convert.ToInt32(dictionary2["form_place_coeff"]);
		}
	}
}

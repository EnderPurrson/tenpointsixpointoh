...
namespace Rilisoft
{
	...
	{
		[CompilerGenerated]
		private sealed class _003CRealPayment_003Ec__AnonStorey295
		{
			internal float inAppPrice;

			internal string inAppName;

			internal string currencyIsoCode;

			internal string paymentId;

			internal Dictionary<string, string> _003C_003Em__23E()
			{
		...
		[CompilerGenerated]
		private sealed class _003CSendFirstTimeRealPayment_003Ec__AnonStorey296
		{
			internal float inAppPrice;
			...
			internal Dictionary<string, string> _003C_003Em__23F()
			{
				string value = inAppPrice.ToString("0.00", CultureInfo.InvariantCulture);
				return new Dictionary<string, string>(4)
				{
		...
		{
			_003CRealPayment_003Ec__AnonStorey295 _003CRealPayment_003Ec__AnonStorey = new _003CRealPayment_003Ec__AnonStorey295();
			_003CRealPayment_003Ec__AnonStorey.inAppPrice = inAppPrice;
			_003CRealPayment_003Ec__AnonStorey.inAppName = inAppName;
			_003CRealPayment_003Ec__AnonStorey.currencyIsoCode = currencyIsoCode;
			_003CRealPayment_003Ec__AnonStorey.paymentId = paymentId;
			Initialize();
			if (_devToDevFacade != null)
			{
				_devToDevFacade.RealPayment(_003CRealPayment_003Ec__AnonStorey.paymentId, _003CRealPayment_003Ec__AnonStorey.inAppPrice, _003CRealPayment_003Ec__AnonStorey.inAppName, _003CRealPayment_003Ec__AnonStorey.currencyIsoCode);
			}
			Lazy<Dictionary<string, string>> lazy = new Lazy<Dictionary<string, string>>(_003CRealPayment_003Ec__AnonStorey._003C_003Em__23E);
			if (_appsFlyerFacade != null)
			{
		...
		{
			_003CSendFirstTimeRealPayment_003Ec__AnonStorey296 _003CSendFirstTimeRealPayment_003Ec__AnonStorey = new _003CSendFirstTimeRealPayment_003Ec__AnonStorey296();
			_003CSendFirstTimeRealPayment_003Ec__AnonStorey.inAppPrice = inAppPrice;
			_003CSendFirstTimeRealPayment_003Ec__AnonStorey.inAppName = inAppName;
			_003CSendFirstTimeRealPayment_003Ec__AnonStorey.currencyIsoCode = currencyIsoCode;
			_003CSendFirstTimeRealPayment_003Ec__AnonStorey.paymentId = paymentId;
			Initialize();
			Lazy<Dictionary<string, string>> lazy = new Lazy<Dictionary<string, string>>(_003CSendFirstTimeRealPayment_003Ec__AnonStorey._003C_003Em__23F);
			if (_appsFlyerFacade != null)
			{

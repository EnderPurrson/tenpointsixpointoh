	...
	public static class Json
	{
		private sealed class Parser : IDisposable
		{
			...
			private char PeekChar
			{
				get
				{
					//Discarded unreachable code: IL_0018, IL_0036
					int num = json.Peek();
					try
					{
			...
			private object ParseNumber()
			{
				...
				{
					long result;
					long.TryParse(nextWord, NumberStyles.Number, CultureInfo.InvariantCulture, out result);
					return result;
				}
				double result2;
				double.TryParse(nextWord, NumberStyles.Number, CultureInfo.InvariantCulture, out result2);
				return result2;
			}

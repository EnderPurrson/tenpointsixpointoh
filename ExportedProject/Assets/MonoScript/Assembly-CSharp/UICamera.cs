...
public class UICamera : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static BetterList<DepthEntry>.CompareFunc _003C_003Ef__am_0024cache5A;

	[CompilerGenerated]
	private static BetterList<DepthEntry>.CompareFunc _003C_003Ef__am_0024cache5B;
		...
		for (int i = 0; i < list.size; i++)
		{
			...
			if (uICamera.eventType == EventType.UI_3D)
			{
				...
				if (array.Length > 1)
				{
					...
					BetterList<DepthEntry> betterList = mHits;
					if (_003C_003Ef__am_0024cache5A == null)
					{
						_003C_003Ef__am_0024cache5A = _003CRaycast_003Em__1D0;
					}
					betterList.Sort(_003C_003Ef__am_0024cache5A);
			...
			else
			{
				...
				if (array2.Length > 1)
				{
					...
					BetterList<DepthEntry> betterList2 = mHits;
					if (_003C_003Ef__am_0024cache5B == null)
					{
						_003C_003Ef__am_0024cache5B = _003CRaycast_003Em__1D1;
					}
					betterList2.Sort(_003C_003Ef__am_0024cache5B);
	...
	public void ProcessTouches()
	{
		...
		for (int i = 0; i < num; i++)
		{
			...
			Raycast(currentTouch);
			if (Defs.touchPressureSupported && Defs.isUse3DTouch && currentTouch.current != null)
			{
	...
	[CompilerGenerated]
	private static int _003CRaycast_003Em__1D0(DepthEntry r1, DepthEntry r2)
	{
		return r2.depth.CompareTo(r1.depth);
	}

	[CompilerGenerated]
	private static int _003CRaycast_003Em__1D1(DepthEntry r1, DepthEntry r2)
	{
		return r2.depth.CompareTo(r1.depth);
	}
}

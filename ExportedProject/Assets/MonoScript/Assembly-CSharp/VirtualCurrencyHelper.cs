...
public sealed class VirtualCurrencyHelper
{
	...
	[CompilerGenerated]
	private static Func<List<string>, IEnumerable<string>> _003C_003Ef__am_0024cacheF;

	[CompilerGenerated]
	private static Func<List<string>, IEnumerable<string>> _003C_003Ef__am_0024cache10;
	...
	static VirtualCurrencyHelper()
	{
		...
		AddPrice("skin_july1", 20);
		AddPrice("skin_july2", 20);
		AddPrice("skin_july3", 20);
		AddPrice("skin_july4", 20);
	...
	public static ItemPrice Price(string key)
	{
		...
		List<List<string>> source = Wear.wear[ShopNGUIController.CategoryNames.ArmorCategory];
		if (_003C_003Ef__am_0024cacheF == null)
		{
			_003C_003Ef__am_0024cacheF = _003CPrice_003Em__474;
		}
		if (source.SelectMany(_003C_003Ef__am_0024cacheF).ToList().Contains(key))
		{
		...
		List<List<string>> source2 = Wear.wear[ShopNGUIController.CategoryNames.MaskCategory];
		if (_003C_003Ef__am_0024cache10 == null)
		{
			_003C_003Ef__am_0024cache10 = _003CPrice_003Em__475;
		}
		IEnumerable<string> source3 = source2.SelectMany(_003C_003Ef__am_0024cache10);
		if (key != "hat_ManiacMask" && source3.Contains(key))
		{
			flag = true;
		}
	...
	[CompilerGenerated]
	private static IEnumerable<string> _003CPrice_003Em__474(List<string> list)
	{
		return list;
	}

	[CompilerGenerated]
	private static IEnumerable<string> _003CPrice_003Em__475(List<string> l)
	{
		return l;
	}
}

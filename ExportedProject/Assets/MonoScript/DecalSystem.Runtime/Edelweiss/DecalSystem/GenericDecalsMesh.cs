...
namespace Edelweiss.DecalSystem
{
	public abstract class GenericDecalsMesh<D, P, DM> : GenericDecalsMeshBase where D : GenericDecals<D, P, DM> where P : GenericDecalProjector<D, P, DM> where DM : GenericDecalsMesh<D, P, DM>
	{
		...
		protected unsafe override void RecalculateUVs()
		{
			...
			if (!((Object)m_Decals != (Object)default(Object)) || m_Decals.CurrentUVMode != 0)
			{
				return;
			}
		...
		{
			bool result = true;
			if ((Object)m_Decals != (Object)default(Object) && m_Decals.CurrentUV2Mode != UV2Mode.Lightmapping)
			{
				result = false;
			}
			return result;
		...
		protected unsafe override void RecalculateUV2s()
		{
			...
			if (!((Object)m_Decals != (Object)default(Object)) || m_Decals.CurrentUV2Mode != UV2Mode.Project)
			{
				return;
			}
			Enumerator<P> enumerator = ((List<_003F>)(object)m_Projectors).GetEnumerator();
		...
		protected unsafe override void RecalculateTangents()
		{
			...
			//IL_0038: Unknown result type (might be due to invalid IL or missing references)
			//IL_006e: Unknown result type (might be due to invalid IL or missing references)
			if (!((Object)m_Decals != (Object)default(Object)) || m_Decals.CurrentTangentsMode != TangentsMode.Project)
			{
				return;
			}
			Enumerator<P> enumerator = ((List<_003F>)(object)m_Projectors).GetEnumerator();
		...
		public unsafe virtual void ClearAll()
		{
			...
			if ((Object)m_Decals != (Object)default(Object))
			{

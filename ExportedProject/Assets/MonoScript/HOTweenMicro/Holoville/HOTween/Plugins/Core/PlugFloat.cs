...
namespace Holoville.HOTween.Plugins.Core
{
	...
	{
		internal static global::System.Type[] validPropTypes = new global::System.Type[2]
		{
			typeof(float),
			typeof(int)
		};

		internal static global::System.Type[] validValueTypes = new global::System.Type[1] { typeof(float) };
		...
		public PlugFloat(float p_endVal)
			: base(p_endVal, false)
		{
		}

		public PlugFloat(float p_endVal, EaseType p_easeType)
			: base(p_endVal, p_easeType, false)
		{
		}

		public PlugFloat(float p_endVal, bool p_isRelative)
			: base(p_endVal, p_isRelative)
		{
		}

		public PlugFloat(float p_endVal, EaseType p_easeType, bool p_isRelative)

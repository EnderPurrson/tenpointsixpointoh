...
namespace Holoville.HOTween.Plugins
{
	public class PlugSetColor : ABSTweenPlugin
	{
		...
		internal static global::System.Type[] validTargetTypes = new global::System.Type[1] { typeof(Material) };

		internal static global::System.Type[] validPropTypes = new global::System.Type[1] { typeof(Color) };

		internal static global::System.Type[] validValueTypes = new global::System.Type[1] { typeof(Color) };
		...
		{
			return Property(((object)p_colorName).ToString());
		}

...
namespace Holoville.HOTween.Plugins
{
	public class PlugVector3Path : ABSTweenPlugin
	{
		...
		internal static global::System.Type[] validPropTypes = new global::System.Type[1] { typeof(Vector3) };

		internal static global::System.Type[] validValueTypes = new global::System.Type[1] { typeof(Vector3[]) };
		...
		protected override object startVal
		{
			...
			set
			{
				if (tweenObj.isFrom)
				{
					...
					global::System.Array.Copy((global::System.Array)array, (global::System.Array)points, array.Length);
					global::System.Array.Reverse((global::System.Array)points);
				}
				else
				{
		...
		internal override void Init(Tweener p_tweenObj, string p_propertyName, EaseType p_easeType, global::System.Type p_targetType, PropertyInfo p_propertyInfo, FieldInfo p_fieldInfo)
		{
			if (isRelative && p_tweenObj.isFrom)
			{
				isRelative = false;
				TweenWarning.Log(string.Concat(new object[5] { "\"", p_tweenObj.target, ".", p_propertyName, "\": PlugVector3Path \"isRelative\" parameter is incompatible with HOTween.From. The tween will be treated as absolute." }));
			}
		...
		protected override void DoUpdate(float p_totElapsed)
		{
			...
			if (orientType == OrientType.None || !(orientTrans != null) || ((object)orientTrans).Equals((object)default(object)))
			{
				return;
			}
			...
			case OrientType.LookAtTransform:
				if (orientTrans != null && !((object)orientTrans).Equals((object)default(object)))
				{

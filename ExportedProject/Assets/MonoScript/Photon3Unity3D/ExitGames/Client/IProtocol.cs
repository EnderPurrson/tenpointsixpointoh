...
namespace ExitGames.Client
{
	public abstract class IProtocol
	{
		...
		public object Deserialize(byte[] serializedData)
		{
			...
			return Deserialize(streamBuffer, (byte)((Stream)streamBuffer).ReadByte());
		}

		public object DeserializeMessage(StreamBuffer stream)
		{
			return Deserialize(stream, (byte)((Stream)stream).ReadByte());
		}

		internal byte[] DeserializeRawMessage(StreamBuffer stream)
		{
			return (byte[])Deserialize(stream, (byte)((Stream)stream).ReadByte());
		}

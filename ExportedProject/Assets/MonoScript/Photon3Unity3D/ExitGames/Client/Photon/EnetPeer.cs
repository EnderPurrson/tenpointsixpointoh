...
namespace ExitGames.Client.Photon
{
	internal class EnetPeer : PeerBase
	{
		...
		private sealed class _003C_003Ec__DisplayClass37_0
		{
			...
			{
				CS_0024_003C_003E8__locals1._003C_003E4__this.rt.Send(dataCopy, CS_0024_003C_003E8__locals1.length);
			}
		}
		...
		private sealed class _003C_003Ec__DisplayClass42_0
		{
			...
			internal void _003CReceiveIncomingCommands_003Eb__0()
			{
		...
		internal void SendData(byte[] data, int length)
		{
			...
			try
			{
				...
				if (base.NetworkSimulationSettings.IsSimulationEnabled)
				{
					...
					_003C_003Ec__DisplayClass37_2.dataCopy = new byte[_003C_003Ec__DisplayClass37_2.CS_0024_003C_003E8__locals1.length];
					Buffer.BlockCopy((global::System.Array)data, 0, (global::System.Array)_003C_003Ec__DisplayClass37_2.dataCopy, 0, _003C_003Ec__DisplayClass37_2.CS_0024_003C_003E8__locals1.length);
					SendNetworkSimulated(_003C_003Ec__DisplayClass37_2._003CSendData_003Eb__0);
				}
				else
				{
		...
		internal override void ReceiveIncomingCommands(byte[] inBuff, int dataLength)
		{
			...
			try
			{
				...
				for (int i = 0; i < b2; i++)
				{
					...
					_003C_003Ec__DisplayClass42_.readCommand = new NCommand(this, inBuff, ref offset);
					if (_003C_003Ec__DisplayClass42_.readCommand.commandType != 1)
					{
						EnqueueActionForDispatch(_003C_003Ec__DisplayClass42_._003CReceiveIncomingCommands_003Eb__0);
					}
					else
					{
						TrafficStatsIncoming.TimestampOfLastAck = SupportClass.GetTickCount();
						ExecuteCommand(_003C_003Ec__DisplayClass42_.readCommand);
					}
					if ((_003C_003Ec__DisplayClass42_.readCommand.commandFlags & 1) > 0)
					{
						if (InReliableLog != null)
						{
							InReliableLog.Enqueue((CmdLogItem)new CmdLogReceivedReliable(_003C_003Ec__DisplayClass42_.readCommand, timeInt, roundTripTime, roundTripTimeVariance, timeInt - timeLastSendOutgoing, timeInt - timeLastSendAck));
							CommandLogResize();
						}
						NCommand nCommand = NCommand.CreateAck(this, _003C_003Ec__DisplayClass42_.readCommand, serverSentTime);
		...
		internal bool ExecuteCommand(NCommand command)
		{
			...
			case 1:
			{
				...
				if (nCommand.commandType == 4 && peerConnectionState == ConnectionStateValue.Disconnecting)
				{
					...
					EnqueueActionForDispatch(_003CExecuteCommand_003Eb__43_0);
				}
		...
		[CompilerGenerated]
		private void _003CExecuteCommand_003Eb__43_0()
		{
			rt.Disconnect();
		}
	}

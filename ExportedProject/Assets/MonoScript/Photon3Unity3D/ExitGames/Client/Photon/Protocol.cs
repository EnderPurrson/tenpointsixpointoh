...
namespace ExitGames.Client.Photon
{
	public class Protocol
	{
		...
		internal static readonly Dictionary<global::System.Type, CustomType> TypeDict = new Dictionary<global::System.Type, CustomType>();
		...
		public static bool TryRegisterType(global::System.Type type, byte typeCode, SerializeMethod serializeFunction, DeserializeMethod deserializeFunction)
		{
		...
		public static bool TryRegisterType(global::System.Type type, byte typeCode, SerializeStreamMethod serializeFunction, DeserializeStreamMethod deserializeFunction)
		{
			if (CodeDict.ContainsKey(typeCode) || TypeDict.ContainsKey(type))
			{
				return false;
		...
		public static void Serialize(float value, byte[] target, ref int targetOffset)
		{
			lock (memFloatBlock)
			{
				...
				Buffer.BlockCopy((global::System.Array)memFloatBlock, 0, (global::System.Array)target, targetOffset, 4);
			}

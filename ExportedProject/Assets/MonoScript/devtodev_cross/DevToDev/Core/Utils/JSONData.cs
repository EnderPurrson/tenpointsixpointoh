...
namespace DevToDev.Core.Utils
{
	public class JSONData : JSONNode
	{
		...
		public JSONData(object aData)
		{
			...
			throw new global::System.Exception(string.Concat((object)"No such type in JSON parser: ", (object)aData.GetType()));
		}
		...
		public override string ToJSON(int prefix)
		{
			...
			case JSONBinaryTag.Value:
				return string.Format("\"{0}\"", (object)JSONNode.Escape(m_Data));
			case JSONBinaryTag.Null:
				return "null";
			default:
				throw new NotSupportedException("This shouldn't be here: " + ((object)Tag).ToString());
			}
		}

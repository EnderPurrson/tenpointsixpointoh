...
namespace DevToDev.Utils.Gzip.Zlib
{
	internal sealed class DeflateManager
	{
		...
		private void _InitializeLazyMatch()
		{
			...
			global::System.Array.Clear((global::System.Array)head, 0, hash_size);
		...
		{
			global::System.Array.Copy((global::System.Array)p, start, (global::System.Array)pending, pendingCount, len);
			pendingCount += len;
		}
		...
		private void _fillWindow()
		{
			do
			{
				...
				{
					global::System.Array.Copy((global::System.Array)window, w_size, (global::System.Array)window, 0, w_size);
					match_start -= w_size;
					strstart -= w_size;
					block_start -= w_size;
					num2 = hash_size;
		...
		internal int Initialize(ZlibCodec codec, CompressionLevel level, int windowBits, int memLevel, CompressionStrategy strategy)
		{
			...
			{
				throw new ZlibException(string.Format("memLevel must be in the range 1.. {0}", (object)MEM_LEVEL_MAX));
			}
			_codec.dstate = this;
			w_bits = windowBits;
			w_size = 1 << w_bits;
		...
		internal int SetDictionary(byte[] dictionary)
		{
			...
			global::System.Array.Copy((global::System.Array)dictionary, num2, (global::System.Array)window, 0, num);
			strstart = num;
			block_start = num;
			ins_h = window[0] & 0xFF;
		...
		internal int Deflate(FlushType flush)
		{
			if (_codec.OutputBuffer == null || (_codec.InputBuffer == null && _codec.AvailableBytesIn != 0) || (status == FINISH_STATE && flush != FlushType.Finish))
			{
				...
				throw new ZlibException(string.Format("Something is fishy. [{0}]", (object)_codec.Message));
			}
			if (_codec.AvailableBytesOut == 0)
			{

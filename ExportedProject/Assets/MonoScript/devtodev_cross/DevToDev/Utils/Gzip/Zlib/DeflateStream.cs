...
namespace DevToDev.Utils.Gzip.Zlib
{
	internal class DeflateStream : Stream
	{
		...
		public static byte[] CompressString(string s)
		{
			...
			try
			{
				Stream compressor = (Stream)(object)new DeflateStream((Stream)(object)val, CompressionMode.Compress, CompressionLevel.BestCompression);
		...
		public static string UncompressString(byte[] compressed)
		{
			...
			try
			{
				Stream decompressor = (Stream)(object)new DeflateStream((Stream)(object)val, CompressionMode.Decompress);

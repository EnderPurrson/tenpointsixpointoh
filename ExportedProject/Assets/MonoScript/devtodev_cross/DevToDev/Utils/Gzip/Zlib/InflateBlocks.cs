...
namespace DevToDev.Utils.Gzip.Zlib
{
	internal sealed class InflateBlocks
	{
		...
		internal int Process(int r)
		{
			...
			while (true)
			{
				...
				case InflateBlockMode.STORED:
				{
					...
					global::System.Array.Copy((global::System.Array)_codec.InputBuffer, num, (global::System.Array)window, num4, num6);
					num += num6;
					num2 -= num6;
					num4 += num6;
					num5 -= num6;
				...
				case InflateBlockMode.TABLE:
				{
					...
					{
						global::System.Array.Clear((global::System.Array)blens, 0, num6);
					}
					num3 >>= 14;
					i -= 14;
					index = 0;
		...
		{
			global::System.Array.Copy((global::System.Array)d, start, (global::System.Array)window, 0, n);
			readAt = (writeAt = n);
		}
		...
		internal int Flush(int r)
		{
			for (int i = 0; i < 2; i++)
			{
				...
				global::System.Array.Copy((global::System.Array)window, readAt, (global::System.Array)_codec.OutputBuffer, _codec.NextOut, num);
				_codec.NextOut += num;
				readAt += num;
				if (readAt == end && i == 0)
				{

	...
	internal sealed class ZlibCodec
	{
		...
		internal void flush_pending()
		{
			...
			if (num != 0)
			{
				...
				{
					throw new ZlibException(string.Format("Invalid State. (pending.Length={0}, pendingCount={1})", (object)dstate.pending.Length, (object)dstate.pendingCount));
				}
				global::System.Array.Copy((global::System.Array)dstate.pending, dstate.nextPending, (global::System.Array)OutputBuffer, NextOut, num);
				NextOut += num;
		...
		internal int read_buf(byte[] buf, int start, int size)
		{
			...
			global::System.Array.Copy((global::System.Array)InputBuffer, NextIn, (global::System.Array)buf, start, num);
			NextIn += num;
			TotalBytesIn += num;
			return num;
		}

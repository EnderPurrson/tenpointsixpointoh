...
public class ButOpenGift : MonoBehaviour
{
	...
	private void AnimHS2()
	{
		...
		HOTween.Kill((object)this);
		HOTween.To((object)this, speedAnim, new TweenParms().Prop("curColorHS", (object)animColor).OnUpdate((TweenCallback)delegate
		{
			SetColor(curColorHS);
		}).OnComplete(new TweenCallback(AnimHS1)));
	}
	...
	private void AnimHS1()
	{
		...
		//IL_004a: Expected O, but got Unknown
		HOTween.Kill((object)this);
		HOTween.To((object)this, speedAnim, new TweenParms().Prop("curColorHS", (object)normalColor).OnUpdate((TweenCallback)delegate
		{
			SetColor(curColorHS);
		}).OnComplete(new TweenCallback(AnimHS2)));
	}

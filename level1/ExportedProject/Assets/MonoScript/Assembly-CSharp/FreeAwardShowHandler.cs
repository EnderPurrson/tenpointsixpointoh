...
public class FreeAwardShowHandler : MonoBehaviour
{
	...
	private SkipReason NeedToSkipCore()
	{
		...
		if (sharedController != null && (sharedController.RentExpiredPoint.Map((Transform r) => r.childCount > 0) || sharedController.SettingsJoysticksPanel.activeSelf || (FeedbackMenuController.Instance != null && FeedbackMenuController.Instance.gameObject.activeSelf) || sharedController.settingsPanel.activeSelf || sharedController.FreePanelIsActive || sharedController.singleModePanel.activeSelf))
		{

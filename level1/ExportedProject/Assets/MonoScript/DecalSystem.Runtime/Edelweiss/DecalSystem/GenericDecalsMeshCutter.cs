...
namespace Edelweiss.DecalSystem
{
	public abstract class GenericDecalsMeshCutter<D, P, DM> where D : GenericDecals<D, P, DM> where P : GenericDecalProjector<D, P, DM> where DM : GenericDecalsMesh<D, P, DM>
	{
		...
		internal void PlaneDecalsMeshCutter(DM a_DecalsMesh, Plane a_Plane)
		{
			...
			{
				Vector3 a_Vertex = a_DecalsMesh.Vertices.get_Item(i);
				RelativeVertexLocation relativeVertexLocation = VertexLocationRelativeToPlane(a_PlaneOrigin, normal, a_Vertex);
				m_RelativeVertexLocations.Add(relativeVertexLocation);
			}
			int count = a_DecalsMesh.Triangles.get_Count();
			...
			{
				int num2 = a_DecalsMesh.Triangles.get_Item(j);
				int num3 = a_DecalsMesh.Triangles.get_Item(j + 1);
				int num4 = a_DecalsMesh.Triangles.get_Item(j + 2);
				RelativeVertexLocation relativeVertexLocation2 = m_RelativeVertexLocations.get_Item(num2 - num);
				RelativeVertexLocation relativeVertexLocation3 = m_RelativeVertexLocations.get_Item(num3 - num);
				RelativeVertexLocation relativeVertexLocation4 = m_RelativeVertexLocations.get_Item(num4 - num);
				...
				Vector3 vector = a_DecalsMesh.Vertices.get_Item(num2);
				Vector3 vector2 = a_DecalsMesh.Vertices.get_Item(num3);
				Vector3 vector3 = a_DecalsMesh.Vertices.get_Item(num4);
				bool flag = Intersect(relativeVertexLocation2, relativeVertexLocation3);
				bool flag2 = Intersect(relativeVertexLocation2, relativeVertexLocation4);
				bool flag3 = Intersect(relativeVertexLocation3, relativeVertexLocation4);
				int num5 = 0;
				int num6 = 0;
				int num7 = 0;
				if (flag)
				{
					...
					num5 = m_GetCutEdgeDelegate(num, num2, num3, vector, vector2, relativeVertexLocation2 == RelativeVertexLocation.Inside, a_IntersectionFactorAB);
				}
				if (flag2)
				{
					DecalRay a_Ray2 = new DecalRay(vector, vector3 - vector);
					float a_IntersectionFactorAB2 = IntersectionFactor(a_Ray2, a_Plane);
					num6 = m_GetCutEdgeDelegate(num, num2, num4, vector, vector3, relativeVertexLocation2 == RelativeVertexLocation.Inside, a_IntersectionFactorAB2);
				}
				if (flag3)
				{
					DecalRay a_Ray3 = new DecalRay(vector2, vector3 - vector2);
					float a_IntersectionFactorAB3 = IntersectionFactor(a_Ray3, a_Plane);
					num7 = m_GetCutEdgeDelegate(num, num3, num4, vector2, vector3, relativeVertexLocation3 == RelativeVertexLocation.Inside, a_IntersectionFactorAB3);
				}
				if (flag && flag2)
				{
					if (relativeVertexLocation2 == RelativeVertexLocation.Inside)
					{
						a_DecalsMesh.Triangles.set_Item(j + 1, num5);
						a_DecalsMesh.Triangles.set_Item(j + 2, num6);
						continue;
					}
					a_DecalsMesh.Triangles.set_Item(j, num5);
				...
				else if (flag && flag3)
				{
					...
					{
						a_DecalsMesh.Triangles.set_Item(j, num5);
						a_DecalsMesh.Triangles.set_Item(j + 2, num7);
						continue;
					}
					a_DecalsMesh.Triangles.set_Item(j + 1, num5);
					a_DecalsMesh.Triangles.Add(num4);
				...
				else if (flag2 && flag3)
				{
					...
					{
						a_DecalsMesh.Triangles.set_Item(j, num6);
						a_DecalsMesh.Triangles.set_Item(j + 1, num7);
						continue;
					}
					a_DecalsMesh.Triangles.set_Item(j + 2, num6);
			...
			for (int num8 = m_ObsoleteTriangleIndices.get_Count() - 1; num8 >= 0; num8--)
			{
				int num9 = m_ObsoleteTriangleIndices.get_Item(num8);
				int num10 = 1;
				while (num8 > 0 && num9 - 3 == m_ObsoleteTriangleIndices.get_Item(num8 - 1))
				{
					num9 -= 3;
					num10++;
					num8--;
			...
			for (int k = 0; k < m_RelativeVertexLocations.get_Count(); k++)
			{
				if (m_RelativeVertexLocations.get_Item(k) == RelativeVertexLocation.Outside)
				{

...
namespace Prime31
{
	public abstract class AbstractManager : MonoBehaviour
	{
		...
		public static void createThreadingCallbackHelper()
		{
			...
			{
				_threadingCallbackHelper = Object.FindObjectOfType(typeof(ThreadingCallbackHelper)) as ThreadingCallbackHelper;
				if (!(_threadingCallbackHelper != null))
				{
					GameObject prime31ManagerGameObject = getPrime31ManagerGameObject();
		...
		public static GameObject getPrime31ManagerGameObject()
		{
			...
			if (_prime31GameObject == null)
			{
				...
				Object.DontDestroyOnLoad(_prime31GameObject);
			}
			return _prime31GameObject;
		}
		...
		public static void initialize(global::System.Type type)
		{
			try
			{
				MonoBehaviour monoBehaviour = Object.FindObjectOfType(type) as MonoBehaviour;
				if (!(monoBehaviour != null))
				{
					GameObject prime31ManagerGameObject = getPrime31ManagerGameObject();
					GameObject gameObject = new GameObject(((MemberInfo)type).get_Name());
			...
			{
				Debug.LogWarning(string.Concat(new object[5] { "It looks like you have the ", type, " on a GameObject in your scene. Our new prefab-less manager system does not require the ", type, " to be on a GameObject.\nIt will be added to your scene at runtime automatically for you. Please remove the script from your scene." }));
			}
		}

		private void Awake()
		{
			base.gameObject.name = ((MemberInfo)((object)this).GetType()).get_Name();

...
namespace Prime31
{
	public class Json
	{
		internal class ObjectDecoder
		{
			...
			{
				Dictionary<string, Action<object, object>> val2 = new Dictionary<string, Action<object, object>>();
				...
				foreach (FieldInfo val3 in fields)
				{
					...
					if (val3.get_FieldType().get_Namespace().StartsWith("System"))
					{
						CS_0024_003C_003E8__locals0.theInfo = val3;
						CS_0024_003C_003E8__locals0.theFieldType = val3.get_FieldType();
						val2.set_Item(((MemberInfo)val3).get_Name(), (Action<object, object>)delegate(object ownerObject, object val)
						{
							CS_0024_003C_003E8__locals0.theInfo.SetValue(ownerObject, Convert.ChangeType(val, CS_0024_003C_003E8__locals0.theFieldType));
						});
					}
				}
				...
				{
					if (val4.get_PropertyType().get_Namespace().StartsWith("System") && val4.get_CanWrite() && val4.GetSetMethod(true) != null)
					{
						...
						CS_0024_003C_003E8__locals1.thePropertyType = val4.get_PropertyType();
						val2.set_Item(((MemberInfo)val4).get_Name(), (Action<object, object>)delegate(object ownerObject, object val)
						{
							CS_0024_003C_003E8__locals1.theInfo.SetValue(ownerObject, Convert.ChangeType(val, CS_0024_003C_003E8__locals1.thePropertyType), (object[])null);
						});
					}
				}
				return val2;
		...
		internal class Serializer
		{
			...
			private void serializeClass(object value)
			{
				...
				foreach (PropertyInfo val2 in properties)
				{
					...
					_builder.Append(":");
					serializeObject(val2.GetValue(value, (object[])null));
					flag = false;
				}
				_builder.Append("}");
			}

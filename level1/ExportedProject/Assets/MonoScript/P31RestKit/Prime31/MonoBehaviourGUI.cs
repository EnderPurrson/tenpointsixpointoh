...
namespace Prime31
{
	public class MonoBehaviourGUI : MonoBehaviour
	{
		...
		public static void loadLevel(int level)
		{
			try
			{
				((MethodBase)typeof(Application).GetMethod("LoadLevel", new global::System.Type[1] { typeof(int) })).Invoke((object)null, new object[1] { level });
			}
			catch
			{
				try
		...
		public static void loadLevel(string level)
		{
			try
			{
				((MethodBase)typeof(Application).GetMethod("LoadLevel", new global::System.Type[1] { typeof(string) })).Invoke((object)null, new object[1] { level });
			}
			catch
			{
				try

namespace ExitGames.Client.Photon
{
	internal class CmdLogReceivedReliable : CmdLogItem
	{
		...
		{
			return string.Format("Read reliable. {0}  TimeSinceLastSend: {1} TimeSinceLastSendAcks: {2}", (object)base.ToString(), (object)TimeSinceLastSend, (object)TimeSinceLastSendAck);
		}
	}
}

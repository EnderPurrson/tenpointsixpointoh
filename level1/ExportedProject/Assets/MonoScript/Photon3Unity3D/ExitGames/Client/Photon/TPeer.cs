...
namespace ExitGames.Client.Photon
{
	internal class TPeer : PeerBase
	{
		...
		internal void SendData(byte[] data)
		{
			...
			try
			{
				bytesOut += CS_0024_003C_003E8__locals0.data.Length;
				if (base.TrafficStatsEnabled)
				{
					TrafficStatsOutgoing.TotalPacketCount++;
				...
				if (base.NetworkSimulationSettings.IsSimulationEnabled)
				{
					...
					{
						CS_0024_003C_003E8__locals0._003C_003E4__this.rt.Send(CS_0024_003C_003E8__locals0.data, CS_0024_003C_003E8__locals0.data.Length);
					});
				}
				else
				{
					rt.Send(CS_0024_003C_003E8__locals0.data, CS_0024_003C_003E8__locals0.data.Length);
				}
			}
